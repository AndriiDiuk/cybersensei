          ...
          <SectionContent>
            ...
            <PageContentWrapper>
              <Paragraph>
                ...
                to tackle challenges in healthcare, insurance, travel, forensic,
                embedded systems, automotive, scientific research, big data
                analytics, and any other field you can imagine.
              </Paragraph>
              <ImageTextRowWrapper>
                <ImageWrapper $imgWidth={pxToVw(780)} $imgHeight={pxToVw(558)}>
                  <Image
              ...
              <ContentDescription>
                At CyberSensei, we thrive on challenges, and the domain of your
                project is never a limitation for us.
                <br />
                <br />
                With our team of versatile professionals and a commitment to
                excellence, we are ready to bring your ideas to life, no matter
                where they belong in the world of innovation. Contact us today,
                and let&apos;s embark on a journey of success together.
              </ContentDescription>
            </PageContentWrapper>
            <DesignElementWrapper>
              <BgSectionContentBottom />
