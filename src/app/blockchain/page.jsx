            ...
            <Main>
              <PageContent>
                <SectionContent>
                  <PageContentTitleWrapper>
                    <ContentTitle>
                      Decentralized solutions that offer transparency, security,
                      and efficiency
                    </ContentTitle>
                    <ContentDescriptionWrapper>
                      <Line />
                      <ContentDescription>
                        ...
                        provider with a strong track record of delivering
                        innovative solutions across multiple blockchain
                        ecosystems.
                      </ContentDescription>
                    </ContentDescriptionWrapper>
                  </PageContentTitleWrapper>
                  <PageContentWrapper>
                    <Paragraph>
                      With our deep expertise and extensive experience in
                      Ethereum, Polygon, and Solana blockchains, as well as
                      proficiency in Solidity and Rust development, we are your
                      trusted partner in navigating the decentralized world.
                    </Paragraph>
                    <Paragraph>
