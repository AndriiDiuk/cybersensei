                ...
                <SectionContent>
                  <PageContentTitleWrapper>
                    ...
                    <ContentDescriptionWrapper>
                      <Line />
                      <ContentDescription>
                        At SoftRequest, we are a team of experienced
                        professionals specializing in the development and
                        optimization of gambling products and startups.
                        <br />
                        <br /> With a track record of successful projects, we
                        have honed our expertise in various areas to provide
                  ...
                  <PageContentWrapper>
                    ...
                    <ImageTextRowWrapper $gambling>
                      <DetachedOnImg $gambling>
                        ...
                        <Paragraph>
                          Our team has a proven record of optimizing distributed
                          high-loaded services, achieving remarkable
                          improvements of up to 5 times in terms of speed and
                          scalability.
                        </Paragraph>
                      </DetachedOnImg>
                      <ImageWrapper
                    ...
                    <Paragraph>
                      ...
                      strategic measures, we help you streamline your operations
                      and maximize your ROI.
                    </Paragraph>
                    <Paragraph>
                      With our cross-platform application development expertise,
                      we ensure that your gambling platform reaches a wider
                      audience.
                    </Paragraph>
                    <Paragraph>
