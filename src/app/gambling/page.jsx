      ...
      <Main>
        <PageContent>
          <SectionContent>
            <PageContentTitleWrapper>
              <ContentTitle>
                Implementing gambling startups, with a particular focus on poker
                and slot
              </ContentTitle>
              <ContentDescriptionWrapper>
                <Line />
                <ContentDescription>
                  ...
                  honed our expertise in various areas to provide comprehensive
            ...
            <PageContentWrapper>
              <Paragraph>
                Additionally, we excel in optimizing existing gambling software,
                leveraging our technical prowess to enhance performance and
                efficiency.
              </Paragraph>
              <Paragraph>
                Our team has a proven record of optimizing distributed
                high-loaded services, achieving remarkable improvements of up to
                5 times in terms of speed and scalability.
              </Paragraph>
